...
def dm_camera_enabled(started: bool, params: Params, CP: car.CarParams) -> bool:
  """Check if the driver monitoring camera is enabled (not disabled by param)."""
  return not params.get_bool("DisableDriverMonitoringCamera")
